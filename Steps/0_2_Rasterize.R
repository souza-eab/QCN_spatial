...
vector  <- st_make_valid(read_sf(dsn= root, layer= "AOI_ALL_Biomes"))
...
for (i in 1:nrow(tiles)) {
  ...
  write_stars(r_cagb, paste0(output, 'tile_', i, '_cagb.tif'), type="Float32", drive="GTiff")
  write_stars(r_cbgb, paste0(output, 'tile_', i, '_cbgb.tif'), type="Float32", drive="GTiff")
  write_stars(r_cdw, paste0(output, 'tile_', i, '_cdw.tif'), type="Float32", drive="GTiff")
  write_stars(r_clitter, paste0(output, 'tile_', i, '_clitter.tif'), type="Float32", drive="GTiff")
  write_stars(r_total, paste0(output, 'tile_', i, '_total.tif'), type="Float32", drive="GTiff")
  write_stars(r_class, paste0(output, 'tile_', i, '_c7_qcnclass.tif'), type="Float32", drive="GTiff")
