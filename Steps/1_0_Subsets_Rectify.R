# GOALS -------------------------------------------------------------------
##  {                                                                                                                                                                    
    ## Script para gerar tabelas auxiliares para relacionar as fitofisionimas do IBGE como entradas da QCN  para retificar e classificar conforme MapBiomas - Coleção 8.
    #}
##
