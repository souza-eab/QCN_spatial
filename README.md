...
| ----- | ----------- |-------|--------|---------------------------------------------|
| `0_Data_Official_tiles` | List all *Rasterize GDAL tiles biomes* files     | 30m   | 'ee.ImgC' | 'projects/mapbiomas-workspace/SEEG/2023/QCN/0_Data_Official_tiles' 
| `0_pastVegetation_v0-1` | List all *Rasterize tiles biomes AMZ* files      | 30m   | 'ee.Img'  | 'projects/mapbiomas-workspace/SEEG/2023/QCN/0_pastVegetation_v0-1' 
| `0_pastVegetation_v0-2` | List all *Rasterize tiles biomes AMZ* files      | 250m  | 'ee.Img'  | 'projects/mapbiomas-workspace/SEEG/2023/QCN/0_pastVegetation_v0-2' 
| `1_Asset_v0-1`          | List all *Rasterize GDAL tiles biomes* files     | 30m   | 'ee.ImgC' | 'projects/mapbiomas-workspace/SEEG/2023/QCN/1_Asset_v0-1' 
| `1_Asset_v0-2`          | List all *Rasterize GDAL tiles biomes* files     | 250m  | 'ee.ImgC' | 'projects/mapbiomas-workspace/SEEG/2023/QCN/1_Asset_v0-2' 
| `2_Asset_v0-1_rect`     | List all *Rasterize GDAL tiles biomes* files     | 30m   | 'ee.ImgC' | 'projects/mapbiomas-workspace/SEEG/2023/QCN/2_Asset_v0-1_rect' 
...
| `4_Asset_v0-2_rect_LIT`     | List all *Rasterize GDAL tiles biomes* files     | 250 & 30m | 'ee.ImgC' | 'projects/mapbiomas-workspace/SEEG/2023/QCN/4_Asset_v0-2_rect_LIT'
